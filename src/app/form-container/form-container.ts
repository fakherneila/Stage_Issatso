...
import { SuperviserInfosComponent } from '../superviser-infos/superviser-infos';  // Adjust path if needed
import { StudentInfosComponent } from '../student-infos/student-infos';  // Adjust path if needed
